 ...
 *
 */
public class MK_2WithUI extends GUIState	{
     ...
     * Default constructor
     */
    protected MK_2WithUI(SimState state)	{
            super(state);
        }
        ...
        public static void main(String[] args)	{
        	MK_2WithUI simple = new MK_2WithUI(
        			new MK_2(System.currentTimeMillis()));
