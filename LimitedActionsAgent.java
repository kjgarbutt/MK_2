...
public final class LimitedActionsAgent implements Steppable	{
	 ...
	 */
    public LimitedActionsAgent(MK_2 g, String homeTract, String workTract,
    ...
    public LimitedActionsAgent(MK_2 g, int homeTract, int workTract,
			GeomPlanarGraphEdge startingEdge, GeomPlanarGraphEdge goalEdge) {
	}
    ...
    */
   private void findNewAStarPath(MK_2 geoTest)	{
   ...
   public void step(SimState state)	{
       ...
       boolean toWork3 = ((MK_2) state).goToWork3;
